...
require (
	...
	github.com/go-go-golems/glazed v0.7.1
	github.com/go-go-golems/go-go-goja v0.0.4
	github.com/go-go-golems/go-go-mcp v0.0.15
	github.com/go-go-golems/pinocchio v0.4.44
...
require (
	...
	github.com/ThreeDotsLabs/watermill v1.5.0 // indirect
	...
	github.com/go-go-golems/bobatea v0.0.29 // indirect
